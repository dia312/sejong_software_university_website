...
<div class="container">
    ...
    <form name="fpasswordlost" action="<?php echo $action_url ?>" onsubmit="return fpasswordlost_submit(this);" method="post" autocomplete="off" class="form-signin">
      <fieldset id="info_fs">
      ...
      <div class="text-center mt-4">
        <input type="submit" value="확인" class="btn btn-secondary">
			...
			<div class="text-center mt-4">
				<button type="button" onclick="window.close();" class="btn btn-lg btn-primary btn-block btn-signin">창닫기</button>
			</div>
    </form>
	</div>
</div>
